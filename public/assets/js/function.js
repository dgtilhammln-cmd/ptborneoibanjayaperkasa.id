(function ($) {
	...
	if ($('.hero-slider').length) {
		const hero_slider = new Swiper('.hero-slider .hero-swiper', {
			slidesPerView : 1,
			speed: 1000,
			spaceBetween: 0,
			loop: true,
	...
	if ($('.products-carousel').length) {
		const products_carousel = new Swiper('.products-carousel .products-swiper', {
			slidesPerView : 4,
			speed: 800,
			spaceBetween: 30,
			loop: $('.products-carousel .swiper-slide').length > 4,
			autoplay: {
				delay: 4000,
				disableOnInteraction: false,
			},

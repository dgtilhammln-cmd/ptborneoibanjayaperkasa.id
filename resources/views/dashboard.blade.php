...
<style>
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .top-bar-left { display: flex; align-items: center; gap: 16px; flex: 1; min-width: 0; }
    .company-avatar {
    ...
    .company-name { font-size: 1.1rem; font-weight: 800; color: var(--text-primary); line-height: 1.2; }
    .company-sub { font-size: 0.75rem; color: var(--text-muted); margin-top: 2px; }
    .company-badges { display: flex; flex-wrap: wrap; gap: 6px; margin-top: 6px; }
    .badge-pill {
    ...
    .badge-blue  { background: var(--accent-blue-light);  color: var(--accent-blue-dark); border: 1px solid var(--accent-blue-mid); }
    .badge-teal  { background: var(--accent-teal-light);  color: #0e7490; border: 1px solid #a5f3fc; }
    .badge-green { background: var(--accent-green-light); color: #065f46; border: 1px solid #a7f3d0; }
    ...
    .info-cell-label {
        ...
        letter-spacing: 0.9px; color: var(--text-muted); margin-bottom: 4px;
    ...
    .info-cell-value.green { color: var(--accent-green); }
    .info-cell-value.blue  { color: var(--accent-blue); }
    .live-badge {
    ...
    .ic-teal   { background: var(--accent-teal-light);   color: var(--accent-teal); }
    ...
    .stat-progress-track {
        height: 5px; background: var(--bg-page); border-radius: 10px; overflow: hidden;
    }
    .stat-progress-fill {
    ...
    .fill-teal   { background: linear-gradient(90deg,#22d3ee,#06b6d4); }
    .fill-violet { background: linear-gradient(90deg,#a78bfa,#7c3aed); }
    ...
    .btn-ghost:hover { color: var(--accent-blue); border-color: var(--accent-blue-mid); background: var(--accent-blue-light); }
    ...
    .blog-table thead th:last-child { text-align: right; }
    .blog-table tbody tr {
        transition: background 0.15s;
        border-bottom: 1px solid var(--border);
    }
    .blog-table tbody tr:last-child { border-bottom: none; }
    .blog-table tbody tr:hover { background: var(--bg-page); }
    .blog-table td { padding: 13px 12px; vertical-align: middle; }
    .blog-thumb {
    ...
    .blog-thumb-placeholder {
        ...
        display: flex; align-items: center; justify-content: center;
        color: var(--accent-blue); font-size: 1rem; flex-shrink: 0;
    }
    .blog-title-text { font-size: 0.85rem; font-weight: 600; color: var(--text-primary); line-height: 1.3; }
    .blog-date { font-size: 0.72rem; color: var(--text-muted); margin-top: 2px; }
    .status-pill {
        font-size: 0.68rem; font-weight: 700;
        padding: 4px 11px; border-radius: 50px;
        display: inline-block;
    }
    .status-published { background: var(--accent-green-light); color: #065f46; border: 1px solid #a7f3d0; }
    .status-draft     { background: var(--accent-amber-light); color: #92400e; border: 1px solid #fde68a; }
    .btn-edit {
    ...
    .btn-edit:hover { background: var(--accent-blue-light); border-color: var(--accent-blue-mid); color: var(--accent-blue); }
    ...
    .mini-stat:hover { border-color: var(--border-hover); background: var(--accent-blue-light); }
    .mini-icon {
        width: 40px; height: 40px; border-radius: 10px;
        display: flex; align-items: center; justify-content: center;
        font-size: 1rem; flex-shrink: 0;
    }
    .mini-icon-label { font-size: 0.65rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.8px; color: var(--text-muted); }
    .mini-icon-value { font-size: 1.4rem; font-weight: 800; color: var(--text-primary); line-height: 1; }
    ...
    .seo-card-deco  { position:absolute; right:-20px; bottom:-20px; width:120px; height:120px; border-radius:50%; background:rgba(255,255,255,.07); }
    .seo-card-deco2 { position:absolute; right:30px;  bottom:30px;  width:60px;  height:60px;  border-radius:50%; background:rgba(255,255,255,.06); }
    .seo-card-deco3 { position:absolute; right:-10px; top:-30px;    width:100px; height:100px; border-radius:50%; background:rgba(255,255,255,.05); }
    .badge-seo {
    ...
    .seo-title { font-size: 1.15rem; font-weight: 800; color: #fff; margin-bottom: 8px; }
    .seo-desc { font-size: 0.8rem; color: rgba(255,255,255,0.75); margin-bottom: 20px; line-height: 1.6; max-width: 95%; }
    .btn-seo {
        background: #fff; color: var(--accent-blue-dark);
    ...
    .btn-seo:hover { transform: translateY(-1px); box-shadow: 0 6px 20px rgba(0,0,0,0.2); color: var(--accent-blue-dark); }
    ...
    .tip-bar strong { color: var(--text-primary); font-weight: 700; }
    .tip-bar a {
        color: var(--accent-blue); font-weight: 600; text-decoration: none;
        white-space: nowrap; font-size: 0.78rem;
        border: 1px solid var(--accent-blue-mid);
        background: var(--accent-blue-light);
        padding: 5px 12px; border-radius: 8px; transition: all 0.2s;
    }
    .tip-bar a:hover { background: var(--accent-blue); color: #fff; }
    ...
    @media (max-width: 768px) {
        ...
        .top-bar-right { width: 100%; overflow-x: auto; }
        .info-cell { min-width: 90px; padding: 10px 14px; }
    }
    @media (max-width: 640px) {
        ...
        .blog-table thead th, .blog-table td { padding: 10px 8px; }
        .blog-title-text { font-size: 0.78rem; }
    }
...
<div class="info-cell">
    ...
    <div class="tip-bar anim" style="animation-delay:0.32s">
        <span>
            ...
            Tip: di <strong>Analitik</strong> default filter biasanya <strong>7 hari</strong>. Pilih <strong>30 Hari</strong> untuk data apple-to-apple.
        </span>
                ...
                <table class="blog-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="status-pill {{ $blog->status == 'published' ? 'status-published' : 'status-draft' }}">
                                    {{ ucfirst($blog->status) }}
                                </span>
                            </td>
        ...
        <div class="right-col">
            ...
            <div class="seo-card anim" style="animation-delay:0.42s">
                ...
                <div style="position:relative;">
                    ...
                    <div class="seo-desc">
                        Optimalkan sekarang agar produk & jasa anda muncul di halaman pertama Google ketika calon buyer mencari.
                    </div>

                ...
                <div class="ag-card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <small class="text-muted">Leave empty to auto-generate from title. Click refresh icon to regenerate.</small>
                            @error('slug')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="content" id="content" class="form-control summernote" rows="15">{{ old('content') }}</textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="ag-card mb-4">
                    ...
                    <div class="card-body">
                        <div id="sectionsContainer">
                            <p class="text-muted text-center py-3" id="noSectionsMsg">No sections added yet. Click "Add Section" to create one.</p>
                        </div>
            ...
            <div class="col-lg-4">
                ...
                <div class="ag-card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-check mb-3">
                            <input type="checkbox" name="show_in_menu" id="show_in_menu" class="form-check-input" value="1">
                        ...
                        <button type="submit" class="btn btn-primary w-100">
                            <i class="mdi mdi-content-save"></i> Save Page
                        </button>
                    </div>
                </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Generate slug when title changes (only if slug is empty)

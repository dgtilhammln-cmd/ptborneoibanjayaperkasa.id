...
@section('content')
                        ...
                        <div class="card bg-light border mb-4">
                            <div class="card-body">
                                ...
                                <div id="advantages-container">
                                    @php
                                        $advantages = old('advantages', $service->advantages ?? []);
                                        if (empty($advantages)) {
                                            $advantages = [
                        ...
                        <div class="card bg-light border mb-4">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    <div>
                                        <h6 class="fw-bold mb-0"><i class="mdi mdi-help-circle-outline me-2"></i>FAQ (Frequently Asked Questions)</h6>
                                        <p class="text-muted small mb-0">Kelola FAQ untuk layanan ini</p>
                                    </div>
                                    <a href="{{ route('admin.faqs.create') }}?service_id={{ $service->id }}" class="btn btn-sm btn-primary">
                                    ...
                                    <table class="table table-sm table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-end">
                                                    <a href="{{ route('admin.faqs.edit', $faq) }}" class="btn btn-sm btn-icon text-primary">
                                ...
                                <div class="text-center text-muted py-3">
                                    <p class="mb-2">Belum ada FAQ untuk layanan ini.</p>
                                    <a href="{{ route('admin.faqs.create') }}?service_id={{ $service->id }}" class="btn btn-sm btn-primary">
                                        <i class="mdi mdi-plus me-1"></i> Tambah FAQ Pertama
                                    </a>
                                </div>
                                @endif
                            </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (serviceNameInput && serviceSlugInput && generateServiceSlugBtn) {

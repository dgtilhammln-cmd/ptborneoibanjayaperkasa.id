...
@section('content')
<style>
    /* Premium 500 Error Page CSS - PT Borneo Iban Jaya Perkasa */
...
<div class="premium-error-section">
    <div class="premium-error-card">
        <div class="premium-error-number">500</div>
        <h1 class="premium-error-title">Terjadi Kesalahan Server</h1>
        <p class="premium-error-desc">Maaf, kami sedang mengalami masalah teknis pada server. Silakan coba kembali beberapa saat lagi.</p>
